            ...
            <div className="w-72 md:w-96 container mx-auto mt-5 p-6 bg-[#e8edfc] shadow-md rounded-md">
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="text-center">
                        <input type="submit" value='Log In' className='h-10 px-3  py-1 text-2xl rounded-md text-white bg-[#272643] hover:bg-[#131221] ml-auto transition ease-in-out duration-500' />
